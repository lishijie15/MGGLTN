...
from layers.Conv_Blocks_dsc_bay import MobileNetV1_LABAY
...
class Times(nn.Module):
    def __init__(self, seq_len, out_len, top_k, d_model, d_ff, num_kernels):
        ...
        self.conv = MobileNetV1_LABAY(self.d_model, self.d_model)
